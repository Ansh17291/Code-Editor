...
const Editior = () => {
  ...
  useEffect(() => {
    ...
    // Fetch initial   project code from the server
    ...
    socket.current.on("codeUpdate", ({ htmlCode, cssCode, jsCode }) => {
  ...
  const handleCodeChange = (newCode, type) => {
    ...
    socket.current.emit("codeChange", {
      projectId: projectID,
      htmlCode: type === "html" ? newCode : htmlCode,
      cssCode: type === "css" ? newCode : cssCode,
      jsCode: type === "js" ? newCode : jsCode
    });
  };
        ...
        <div className={`left w-[${isExpanded ? "100%" : "50%"}]`}>
          <div className="tabs flex items-center justify-between gap-2 w-full bg-[#1A1919] h-[50px] px-[40px]">
            <div className="tabs flex items-center gap-2">
              ...
              }} className='btnBlue ml-[90px]'>Share Code</button>
            </div>
